...
// for IE excanvas.js see http://explorercanvas.blogspot.com/
  ...
  var x_axis_time    = true ;
  var x_axis_editors = false ;
  var x_axis_mode    = x_axis_time ;

  var y_axis_log = true ;
  var y_axis_lin = false ;
  var y_axis_mode = y_axis_log ;
      ...
      if (a[i].show)
      {
        ...
        { 
          ...
          { 
            ...
            { c = setcolors (a[i].value, a[i].r, 0.3 + (a[i].transparency_fill-0.3) / (7-a[i].r), 0.3 + (a[i].transparency_line-0.3) / (7-a[i].r)) ; }
          }
